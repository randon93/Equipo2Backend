package com.labceiba.bibliotecaceiba.config.timezone;

import com.labceiba.bibliotecaceiba.BibliotecaceibaApp;
import com.labceiba.bibliotecaceiba.repository.timezone.DateTimeWrapper;
import com.labceiba.bibliotecaceiba.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM bc_date_time_wrapper where id=%d", fieldName, id);
    }
